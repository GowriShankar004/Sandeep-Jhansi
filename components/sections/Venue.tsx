...
export function Venue() {
  return (
    <section id="venue" className="relative w-full overflow-hidden px-4 pt-8 pb-4 text-center sm:px-8 sm:pt-16 sm:pb-12">
      <ColorSplash tone="maroon" className="bottom-4 right-4 h-32 w-32 sm:h-48 sm:w-48" />
      ...
      <motion.div
        ...
        className="mx-auto mt-5 aspect-video w-full max-w-2xl overflow-hidden rounded-2xl border border-gold/20 shadow-lg"
      >
        <iframe
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.97 }}
        className="mt-5 inline-flex items-center gap-2 rounded-full border border-gold/50 px-6 py-3 font-body text-xs font-semibold tracking-wide text-gold transition-colors hover:bg-gold/10 sm:text-sm"
      >
